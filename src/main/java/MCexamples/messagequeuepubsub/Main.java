package MCexamples.messagequeuepubsub;
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        final com.uditagarwal.SleepingSubscriber sub1 = new com.uditagarwal.SleepingSubscriber("sub1", 10000);
        final com.uditagarwal.SleepingSubscriber sub2 = new com.uditagarwal.SleepingSubscriber("sub2", 10000);
        queue.subscribe(sub1, topic1);
        queue.subscribe(sub2, topic1);

        final com.uditagarwal.SleepingSubscriber sub3 = new com.uditagarwal.SleepingSubscriber("sub3", 5000);
