...
public class CustomSchedulerService implements ScheduledExecutorService{
...
//                        Ideally it should be -> task.getScheduledTime() + task.getUnit().toMillis(task.getPeriod());
    ...
    public static void main(String[] args) {
        ...
        schedulerService.scheduleAtFixedRate(task2,1, 3, TimeUnit.SECONDS);

        Runnable task3 = getRunnableTask("Task3");
        schedulerService.scheduleWithFixedDelay(task3,1,3,TimeUnit.SECONDS);
